class User < ActiveRecord::Base
  ...
  has_many :responses
  has_many :timeslots, :through => :responses, :class_name => "Timeslot", :order => 'responses.created_at DESC'
  has_many :moments, :through => :timeslots, :class_name => "Moment", :order => 'timeslots.starts_at DESC'
